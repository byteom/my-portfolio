const Skills = () => {
  const skills = [
    ...
    { name: "Python", color: "hover:shadow-blue-300" },
    { name: "TypeScript", color: "hover:shadow-blue-600" },
    { name: "Kubernetes", color: "hover:shadow-indigo-500" },
    { name: "GraphQL", color: "hover:shadow-pink-400" },
    { name: "Redux", color: "hover:shadow-purple-500" },
  ];
