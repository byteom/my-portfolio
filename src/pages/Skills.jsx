const Skills = () => {
  ...
  return (
    <div className="p-8 bg-gray-100 dark:bg-gray-900 min-h-screen">
      <h2 className="text-4xl font-extrabold text-teal-600 dark:text-teal-300 text-center mb-8">Skills</h2>
      <ul className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {skills.map((skill, idx) => (
          <li
            key={idx}
            className={`bg-white dark:bg-gray-800 p-4 rounded-xl text-center text-lg font-semibold text-gray-800 dark:text-gray-200 transition-shadow duration-500 hover:text-teal-600 ${skill.color} hover:shadow-lg`}
          >
